...
public class SQLSelectCompositeIndexDirectSearchTest {
	...
	public void testBetween() throws Exception {
		final List<ODocument> resultList = database.command(
				new OCommandSQL("select * from index:SQLSelectCompositeIndexDirectSearchTestIndex where key between [2, 5] and [5, 6]"))
				.execute();
	...
	public void testIn() {
		final List<ODocument> resultList = database.command(
				new OCommandSQL("select * from index:SQLSelectCompositeIndexDirectSearchTestIndex where key in [[2, 5], [3, 4], [7, 7]]"))
				.execute();
	...
	public void testEqualsPartialPrimitive() {
		final List<ODocument> resultList = database.command(
				new OCommandSQL("select * from index:SQLSelectCompositeIndexDirectSearchTestIndex where key = 2")).execute();
	...
	public void testBetweenPartialPrimitive() throws Exception {
		final List<ODocument> resultList = database.command(
				new OCommandSQL("select * from index:SQLSelectCompositeIndexDirectSearchTestIndex where key between 2 and 5")).execute();
	...
	public void testBetweenPartialComposite() throws Exception {
		final List<ODocument> resultList = database.command(
				new OCommandSQL("select * from index:SQLSelectCompositeIndexDirectSearchTestIndex where key between [2] and [5]"))
				.execute();
		Assert.assertEquals(resultList.size(), 40);
	...
	public void testMinorPartialPrimitive() throws Exception {
		final List<ODocument> resultList = database.command(
				new OCommandSQL("select * from index:SQLSelectCompositeIndexDirectSearchTestIndex where key < 5")).execute();
	...
	public void testMinorEqualsPartialPrimitive() {
		final List<ODocument> resultList = database.command(
				new OCommandSQL("select * from index:SQLSelectCompositeIndexDirectSearchTestIndex where key <= 4")).execute();
		Assert.assertEquals(resultList.size(), 50);
	...
	public void testInPartialPrimitive() {
		final List<ODocument> resultList = database.command(
				new OCommandSQL("select * from index:SQLSelectCompositeIndexDirectSearchTestIndex where key in [2, 3, 7]")).execute();
